...
from model_char.raw_dataset import LargeRawDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_folder', default='./us2015/07_result')
    ...
    parser.add_argument('--update', choices=['Adam', 'Adagrad', 'Adadelta'], default='Adam')
    ...
    train_loader = LargeRawDataset(args.dataset_folder, args.batch_size, args.sequence_length, lm_char_dict, lm_type_dict, args.reverse)
